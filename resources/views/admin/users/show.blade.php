        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <div class="space-y-6">
                <div class="flex items-center space-x-3">
                    <span class="px-3 py-1 {{ $user->role === 'admin' ? 'bg-purple-100 text-purple-800' : ($user->role === 'owner' ? 'bg-blue-100 text-blue-800' : 'bg-gray-100 text-gray-800') }} text-sm rounded-full">
                        {{ ucfirst($user->role) }}
                    </span>
                    <span class="px-3 py-1 {{ $user->is_active ? 'bg-emerald-100 text-emerald-800' : 'bg-gray-100 text-gray-800' }} text-sm rounded-full">
