...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
    <div class="bg-white rounded-lg shadow-md p-6">
        ...
        <div class="flex space-x-2">
            <a href="{{ route('admin.places.index') }}" class="px-4 py-2 bg-emerald-600 text-white text-sm rounded-lg hover:bg-emerald-700">View All</a>
            <a href="{{ route('admin.places.create') }}" class="px-3 py-2 border-2 border-emerald-600 text-emerald-600 text-sm rounded-lg hover:bg-emerald-50">+ Add</a>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        ...
        <div class="flex space-x-2">
            <a href="{{ route('admin.users.index') }}" class="px-4 py-2 bg-emerald-600 text-white text-sm rounded-lg hover:bg-emerald-700">View All</a>
            <a href="{{ route('admin.users.create') }}" class="px-3 py-2 border-2 border-emerald-600 text-emerald-600 text-sm rounded-lg hover:bg-emerald-50">+ Add</a>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        ...
        <div class="flex space-x-2">
            <a href="{{ route('admin.categories.index') }}" class="px-4 py-2 bg-emerald-600 text-white text-sm rounded-lg hover:bg-emerald-700">View All</a>
            <a href="{{ route('admin.categories.create') }}" class="px-3 py-2 border-2 border-emerald-600 text-emerald-600 text-sm rounded-lg hover:bg-emerald-50">+ Add</a>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        ...
        <div class="text-xs text-gray-600 mb-4">
            Avg Rating: <span class="text-emerald-600 font-medium">{{ number_format($stats['avg_rating'] ?? 0, 1) }}</span> ⭐
        </div>
        <div class="flex space-x-2">
            <a href="{{ route('admin.reviews.index') }}" class="px-4 py-2 bg-emerald-600 text-white text-sm rounded-lg hover:bg-emerald-700">View All</a>
        </div>
    </div>
</div>
                ...
                <tbody class="divide-y divide-gray-200">
                    @forelse($stats['recent_places'] as $place)
                        <tr class="hover:bg-gray-50">
                            <td class="px-6 py-4">
                                <a href="{{ route('admin.places.show', $place) }}" class="text-gray-900 font-medium hover:text-emerald-600">
