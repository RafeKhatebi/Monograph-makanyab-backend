...
@section('content')
    <section class="card admin-category-form" aria-label="{{ __('admin.crud.add', ['item' => __('admin.dashboard.categories')]) }}">
        <div class="card-header admin-card-header">
            <h2 class="admin-card-title">{{ __('admin.crud.add', ['item' => __('admin.dashboard.categories')]) }}</h2>
                ...
                <div class="admin-form-grid">
                    ...
                    <div>
                        ...
                        <input type="text" id="schema_type" name="schema_type"
                            value="{{ old('schema_type', 'LocalBusiness') }}"
