            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <a href="{{ route('admin.places.show', $review->place) }}" class="text-emerald-600 hover:underline">
                            {{ $review->place->name }}
                        </a>
                    </div>
                    ...
                    <div>
                        ...
                        <a href="{{ route('admin.users.show', $review->user) }}" class="text-emerald-600 hover:underline">
                            {{ $review->user->name }}
                        </a>
                    </div>
                </div>
