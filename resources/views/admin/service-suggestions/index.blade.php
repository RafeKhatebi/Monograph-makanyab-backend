...
@section('title', __('admin.suggestions.service_title'))
@section('page-title', __('admin.suggestions.service_title'))

@section('content')
    <section class="card" aria-label="{{ __('admin.suggestions.service_title') }}">
        <div class="card-header admin-card-header">
            <h2 class="admin-card-title">{{ __('admin.suggestions.pending_service') }}</h2>
            <form method="GET" action="{{ route('admin.service-suggestions.index') }}" role="search" aria-label="{{ __('admin.suggestions.filter_aria') }}" class="admin-filter-form admin-filter-form--compact">
        ...
        <div class="card-body">
            <div class="admin-table-wrap">
                <table class="table" aria-label="{{ __('admin.suggestions.list_aria', ['type' => __('admin.suggestions.service_title')]) }}">
                    <thead>
                        <tr>
