            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <div class="space-y-6">
                    <div class="flex items-center space-x-3">
                        ...
                        @endif
                        <span
                            class="px-3 py-1 {{ $place->is_active ? 'bg-emerald-100 text-emerald-800' : 'bg-gray-100 text-gray-800' }} text-sm rounded-full">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <p class="text-gray-900">{{ number_format($place->average_rating, 1) }} ⭐
                                ({{ $place->reviews_count }} reviews)</p>
                        </div>
                    </div>
                            ...
                            <p class="text-gray-900">
                                @if ($place->website)
                                    <a href="{{ $place->website }}" target="_blank"
                                        class="text-emerald-600 hover:underline">{{ $place->website }}</a>
                                @else
                                    N/A
                                @endif
                            </p>
