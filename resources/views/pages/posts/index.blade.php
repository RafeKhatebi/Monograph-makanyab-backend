            ...
            <div class="row" style="margin-bottom:40px;">
                <div class="col-md-12">
                    <div class="box-two" style="padding:45px; border-radius:16px; text-align:center;">
                        <h1 style="font-size:38px; font-weight:700; color:#111827; margin-bottom:15px;">Latest Articles</h1>
                        <p style="font-size:17px; color:#6B7280; line-height:1.8; margin:0; max-width:760px; margin-left:auto; margin-right:auto;">
                            Stay informed with the latest business news, local guides, and updates from Makanyab.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-8">
                    @if (isset($posts) && $posts->count())
                        @foreach ($posts as $post)
                            <div class="box-two" style="padding:0; border-radius:16px; overflow:hidden; margin-bottom:35px;">
                                ...
                                <div style="padding:30px;">
                                    <div style="margin-bottom:15px; display:flex; flex-wrap:wrap; gap:10px; align-items:center;">
                                        <span style="background:#ECFDF5; color:#10B981; padding:8px 16px; border-radius:999px; font-size:13px; font-weight:600;">{{ $post->category->name ?? 'News' }}</span>
                                        <span style="color:#9CA3AF; font-size:14px;">{{ $post->created_at->format('M d, Y') }}</span>
                                    </div>

                                    <h2 style="font-size:30px; font-weight:700; line-height:1.4; margin-bottom:15px;">
                                        <a href="{{ route('posts.show', $post->slug) }}" style="color:#111827; text-decoration:none;">{{ $post->title }}</a>
                                    </h2>
                    ...
                    @else
                        <div class="box-two text-center" style="padding:60px 30px; border-radius:16px;">
                            ...
                            <h3 style="font-size:28px; font-weight:700; color:#111827; margin-bottom:15px;">No Posts Found</h3>
                            <p style="font-size:16px; color:#6B7280; margin:0;">New articles and updates will be published soon.</p>
                        </div>
                    @endif
                </div>
                ...
                <div class="col-md-4">
                    <div class="box-two" style="padding:30px; border-radius:16px; margin-bottom:30px;">
                        <h3 style="font-size:24px; font-weight:700; color:#111827; margin-bottom:18px;">Recent Posts</h3>
                        @if(isset($recentPosts) && $recentPosts->count())
                            ...
                            @endforeach
                        @else
                            <p style="color:#6B7280; margin:0;">No recent posts available.</p>
                        @endif
                    </div>
                    <div class="box-two" style="padding:30px; border-radius:16px;">
                        <h3 style="font-size:24px; font-weight:700; color:#111827; margin-bottom:18px;">Need Help?</h3>
                        <p style="color:#6B7280; line-height:1.8; margin-bottom:20px;">If you need advice for listing promotions or service discovery, contact our support team.</p>
