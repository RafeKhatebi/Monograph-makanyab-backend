...
@section('content')
    ...
    <div style="background:linear-gradient(135deg,#064e3b,#10B981);padding:40px 0;">
        <div class="container">
            ...
            <p style="color:rgba(255,255,255,.8);margin:0;font-size:15px;">Discover verified businesses and places near you.
            </p>
        </div>
    </div>
                    ...
                    <div class="row">
                        ...
                        @empty
                            <div class="col-md-12 text-center" style="padding:80px 0;">
                                ...
                                <h3 style="font-size:22px;font-weight:700;color:#111827;margin-bottom:12px;">No places found
                                </h3>
                                <p style="color:#6B7280;margin-bottom:24px;">Try adjusting your filters.</p>
                                <a href="{{ route('places.index') }}"
                                    style="background:#10B981;color:#fff;padding:12px 28px;border-radius:10px;font-weight:700;text-decoration:none;">Reset
                                    Filters</a>
                            </div>
                        @endforelse
                    </div>
