...
@section('content')
    ...
    <div class="listing-hero">
        <div class="container">
            <h1 class="listing-hero__title">Browse Places</h1>
            <p class="listing-hero__text">Discover verified businesses and places near you.</p>
        </div>
    </div>
                    ...
                    <div class="listing-filter-panel listing-filter-panel--sticky">
                        ...
                        <form action="{{ route('places.index') }}" method="GET">
                            ...
                            @if (request()->anyFilled(['search', 'city', 'category', 'status', 'price_level', 'rating', 'open_now', 'verified']))
                                <a href="{{ route('places.index') }}" class="search-filter-reset">Reset All</a>
                            @endif
                        </form>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        @empty
                            <div class="col-md-12 listing-empty">
                                ...
                                <h3 class="mk-heading mk-heading--md">No places found</h3>
                                <p class="mk-text--muted mk-stack-sm">Try adjusting your filters.</p>
                                <a href="{{ route('places.index') }}" class="mk-button mk-button--primary mk-button--md">Reset Filters</a>
                            </div>
                        @endforelse
                    </div>
