        ...
        <div class="container">
            <div class="row places-layout">
                ...
                <div class="col-md-3" style="margin-bottom:24px;">
                    <div style="background:#fff;border-radius:14px;padding:24px;border:1px solid #E5E7EB;position:sticky;top:20px;">
                        ...
                        <form action="{{ route('places.index') }}" method="GET">
                            ...
                            @if (request()->anyFilled(['search', 'city', 'category', 'status', 'price_level', 'rating', 'open_now', 'verified']))
                                <a href="{{ route('places.index') }}"
                                    style="display:block;text-align:center;margin-top:10px;color:#6B7280;font-size:13px;text-decoration:none;">Reset All</a>
                            @endif
                        </form>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        @empty
                            <div class="col-md-12 text-center" style="padding:80px 0;">
                                ...
                                <a href="{{ route('places.index') }}"
                                    style="background:#10B981;color:#fff;padding:12px 28px;border-radius:10px;font-weight:700;text-decoration:none;">Reset Filters</a>
                            </div>
                        @endforelse
                    </div>
