...
<div style="background:linear-gradient(135deg,#064e3b,#10B981);padding:50px 0;">
    <div class="container text-center">
        ...
        <p style="color:rgba(255,255,255,.85);font-size:16px;margin:0;max-width:600px;margin-left:auto;margin-right:auto;">
        ...
        <div class="row">
                ...
                <div style="background:#fff;border-radius:14px;padding:32px;border:1px solid #E5E7EB;height:100%;">
                    ...
                    <div style="display:flex;align-items:flex-start;gap:14px;margin-bottom:22px;">
                        ...
                        <div>
                            ...
                            <a href="tel:+93728958411" style="font-size:14px;color:#10B981;text-decoration:none;">+93 728 958 411</a>
                        </div>
                    </div>
                    ...
                    <div style="display:flex;align-items:flex-start;gap:14px;margin-bottom:22px;">
                        ...
                        <div>
                            ...
                            <a href="mailto:info@makanyab.com" style="font-size:14px;color:#10B981;text-decoration:none;">info@makanyab.com</a>
                        </div>
                    </div>
                    ...
                    <div style="border-top:1px solid #E5E7EB;padding-top:20px;">
                        ...
                        <div style="display:flex;gap:10px;">
                            <a href="#" style="width:38px;height:38px;background:#1F2937;color:#9CA3AF;border-radius:10px;display:flex;align-items:center;justify-content:center;text-decoration:none;font-size:16px;transition:background .2s;" onmouseover="this.style.background='#10B981';this.style.color='#fff'" onmouseout="this.style.background='#1F2937';this.style.color='#9CA3AF'"><i class="fa fa-facebook"></i></a>
                            <a href="#" style="width:38px;height:38px;background:#1F2937;color:#9CA3AF;border-radius:10px;display:flex;align-items:center;justify-content:center;text-decoration:none;font-size:16px;transition:background .2s;" onmouseover="this.style.background='#10B981';this.style.color='#fff'" onmouseout="this.style.background='#1F2937';this.style.color='#9CA3AF'"><i class="fa fa-instagram"></i></a>
                            <a href="#" style="width:38px;height:38px;background:#1F2937;color:#9CA3AF;border-radius:10px;display:flex;align-items:center;justify-content:center;text-decoration:none;font-size:16px;transition:background .2s;" onmouseover="this.style.background='#10B981';this.style.color='#fff'" onmouseout="this.style.background='#1F2937';this.style.color='#9CA3AF'"><i class="fa fa-twitter"></i></a>
                        </div>
                    </div>
            ...
            <div class="col-md-8" style="margin-bottom:30px;">
                <div style="background:#fff;border-radius:14px;padding:36px;border:1px solid #E5E7EB;">
                    ...
                    @if(session('success'))
                        <div style="padding:14px 18px;background:#ECFDF5;border:1px solid #A7F3D0;color:#065F46;border-radius:10px;margin-bottom:22px;font-size:14px;">
                    ...
                    <form action="{{ route('contact.store') }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div style="margin-bottom:16px;">
                                    <label style="font-size:13px;font-weight:600;color:#374151;margin-bottom:6px;display:block;">Full Name *</label>
                                    ...
                                    @error('name')<small style="color:#DC2626;font-size:12px;">{{ $message }}</small>@enderror
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div style="margin-bottom:16px;">
                                    ...
                                    <input type="text" name="telephone" value="{{ old('telephone') }}" required
                                        style="width:100%;height:46px;padding:0 14px;border:1.5px solid #D1D5DB;border-radius:10px;font-size:14px;outline:none;transition:border-color .2s;"
                                        onfocus="this.style.borderColor='#10B981'" onblur="this.style.borderColor='#D1D5DB'">
                                    @error('telephone')<small style="color:#DC2626;font-size:12px;">{{ $message }}</small>@enderror
                                </div>
                            </div>
                        </div>
                        <div style="margin-bottom:16px;">
                        ...
                        <div style="margin-bottom:16px;">
                            <label style="font-size:13px;font-weight:600;color:#374151;margin-bottom:6px;display:block;">Subject</label>
                            <input type="text" name="subject" value="{{ old('subject') }}"
                                style="width:100%;height:46px;padding:0 14px;border:1.5px solid #D1D5DB;border-radius:10px;font-size:14px;outline:none;transition:border-color .2s;"
                                onfocus="this.style.borderColor='#10B981'" onblur="this.style.borderColor='#D1D5DB'">
                        </div>
                        <div style="margin-bottom:22px;">
                            <label style="font-size:13px;font-weight:600;color:#374151;margin-bottom:6px;display:block;">Message *</label>
                            ...
                            @error('message')<small style="color:#DC2626;font-size:12px;">{{ $message }}</small>@enderror
                        </div>
                        <button type="submit" style="background:#10B981;color:#fff;border:none;padding:13px 32px;font-size:15px;font-weight:700;border-radius:10px;cursor:pointer;transition:background .2s;"
