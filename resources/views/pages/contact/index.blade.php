...
@section('content')
    ...
    <div class="mk-hero">
        <div class="container text-center">
            <h1 class="mk-hero__title">Contact Us</h1>
            ...
            <div class="row">
                <div class="col-md-4 mk-stack-md">
                    <div class="mk-card mk-card--feature">
                        <h3 class="mk-heading mk-heading--md">Get in Touch</h3>
                        ...
                        <div class="mk-icon-item">
                            ...
                            <div>
                                <p class="mk-meta-label">Office Address</p>
                        ...
                        <div class="mk-icon-item">
                            ...
                            <div>
                                <p class="mk-meta-label">Working Hours</p>
                                <p class="mk-meta-value">Sat - Thu, 9:00 AM - 6:00 PM</p>
                            </div>
                        </div>

                        <div class="mk-social">
                            <p class="mk-meta-label mk-stack-sm">Follow Us</p>
                ...
                <div class="col-md-8 mk-stack-md">
                    <div class="mk-card">
                        <h3 class="mk-heading mk-heading--md mk-stack-sm">Send Us a Message</h3>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mk-form-group">
                                        <label class="mk-label">Full Name *</label>
                                ...
                                <div class="col-md-6">
                                    <div class="mk-form-group">
                                        <label class="mk-label">Phone *</label>
