        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2 text-center">
                ...
                <p style="font-size:17px;color:rgba(255,255,255,.85);line-height:1.8;margin-bottom:28px;">
                    The local discovery platform connecting people with the best services, businesses and places in Afghanistan.
                </p>
...
<div style="background:#F8FAFC;padding:60px 0;">
    <div class="container">
        ...
        <div class="row" style="margin-bottom:60px;align-items:center;">
            ...
            <div class="col-md-6" style="margin-bottom:30px;">
                <div style="background:#fff;border-radius:16px;padding:40px;text-align:center;border:1px solid #E5E7EB;">
        ...
        <div class="row" style="margin-bottom:60px;">
            <div class="col-md-4" style="margin-bottom:24px;">
                <div style="background:#fff;border-radius:14px;padding:32px;text-align:center;border:1px solid #E5E7EB;height:100%;">
        ...
        <div class="row" style="margin-bottom:60px;">
            <div class="col-md-6" style="margin-bottom:24px;">
                <div style="background:#fff;border-radius:14px;padding:36px;border:1px solid #E5E7EB;border-left:4px solid #10B981;">
