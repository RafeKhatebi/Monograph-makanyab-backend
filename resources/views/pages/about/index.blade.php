...
<div class="content-area" style="background-color: #FCFCFC; padding: 55px 0;">
    <div class="container">
        ...
        <div class="row" style="margin-bottom: 50px;">
            <div class="col-md-12 text-center">
                ...
                <p style="font-size: 18px; color: #6B7280; max-width: 800px; margin: 0 auto; line-height: 1.8;">
                    Makanyab is your trusted guide to finding restaurants, cafes, hotels, and entertainment venues across Afghanistan. 
        ...
        <div class="row" style="margin-bottom: 50px;">
            <div class="col-md-4" style="margin-bottom: 30px;">
                <div class="box-two" style="text-align: center; padding: 40px 30px; height: 100%;">
                    ...
                    <h3 style="font-size: 22px; font-weight: 600; color: #111827; margin-bottom: 15px;">Easy Discovery</h3>
                    <p style="color: #6B7280; line-height: 1.6; margin: 0;">
                        Search and filter through thousands of places to find exactly what you're looking for in your city.
                    </p>
                </div>
            </div>
            ...
            <div class="col-md-4" style="margin-bottom: 30px;">
                <div class="box-two" style="text-align: center; padding: 40px 30px; height: 100%;">
                    <div style="font-size: 48px; margin-bottom: 20px;">⭐</div>
                    <h3 style="font-size: 22px; font-weight: 600; color: #111827; margin-bottom: 15px;">Trusted Reviews</h3>
                    <p style="color: #6B7280; line-height: 1.6; margin: 0;">
            ...
            <div class="col-md-4" style="margin-bottom: 30px;">
                <div class="box-two" style="text-align: center; padding: 40px 30px; height: 100%;">
                    <div style="font-size: 48px; margin-bottom: 20px;">📍</div>
                    <h3 style="font-size: 22px; font-weight: 600; color: #111827; margin-bottom: 15px;">Detailed Information</h3>
                    <p style="color: #6B7280; line-height: 1.6; margin: 0;">
                        Get complete details including location, contact info, opening hours, and photos for every place.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="row" style="margin-bottom: 50px;">
            ...
            <div class="col-md-6" style="margin-bottom: 30px;">
                <div class="box-two" style="padding: 40px; height: 100%;">
                    <h3 style="font-size: 28px; font-weight: 700; color: #10B981; margin-bottom: 20px;">Why Choose Us</h3>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box-two" style="text-align: center; padding: 60px 40px; background: linear-gradient(135deg, #10B981 0%, #059669 100%);">
                    <h3 style="font-size: 32px; font-weight: 700; color: #FFFFFF; margin-bottom: 20px;">
                        Join Our Community Today
                    </h3>
                    <p style="font-size: 18px; color: #FFFFFF; margin-bottom: 30px; opacity: 0.9;">
                        Start discovering amazing places and sharing your experiences
                    </p>
                    <div>
                        @guest
                            <a href="{{ route('register') }}" class="btn btn-lg" style="background: #FFFFFF; color: #10B981; padding: 15px 40px; font-weight: 600; border-radius: 8px; margin-right: 15px;">
                                Sign Up Free
                            </a>
                            <a href="{{ route('places.index') }}" class="btn btn-lg" style="background: transparent; color: #FFFFFF; border: 2px solid #FFFFFF; padding: 15px 40px; font-weight: 600; border-radius: 8px;">
                                Explore Places
                            </a>
                        @else
                            <a href="{{ route('places.index') }}" class="btn btn-lg" style="background: #FFFFFF; color: #10B981; padding: 15px 40px; font-weight: 600; border-radius: 8px;">
                                Explore Places
                            </a>
                        @endguest
                    </div>
