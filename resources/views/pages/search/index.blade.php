...
@section('content')
    ...
    <div style="background:#F8FAFC;padding:30px 0 70px;">
        <div class="container">
            ...
            <div class="row search-layout">
                {{-- Sidebar Filters --}}
                <aside class="col-md-3 search-sidebar" style="margin-bottom:24px;">
                    <div id="search-filter-panel" class="responsive-filter-panel"
                        style="background:#fff;border-radius:14px;padding:24px;border:1px solid #E5E7EB;position:sticky;top:20px;max-height:calc(100vh - 40px);overflow-y:auto;">
                        ...
                        <form action="{{ route('search.index') }}" method="GET">
                            ...
                            <div style="margin-bottom:16px;">
                                <label style="font-size:13px;font-weight:600;color:#374151;margin-bottom:6px;display:block;">Sort</label>
                                <select name="sort"
                            ...
                            <div style="margin-bottom:16px;">
                                <label style="font-size:13px;font-weight:600;color:#374151;margin-bottom:6px;display:block;">Rating</label>
                                <select name="rating"
                                    style="width:100%;height:42px;padding:0 12px;border:1px solid #D1D5DB;border-radius:8px;font-size:14px;background:#fff;outline:none;">
    ...
    @push('styles')
        <style>
            ...
            [dir="rtl"] .search-sidebar {
                float: right;
            }

            [dir="rtl"] .search-layout > .col-md-9 {
                float: right;
            }
        </style>
    @endpush
