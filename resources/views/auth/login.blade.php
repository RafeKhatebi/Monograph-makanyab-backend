                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div style="text-align: center; margin-top: 20px;">
                            @if (Route::has('password.request'))
                                <a href="{{ route('password.request') }}" style="color: #10B981; text-decoration: none; font-size: 14px;">
                        ...
                        <div style="text-align: center; margin-top: 20px; padding-top: 20px; border-top: 1px solid #e5e7eb;">
                            ...
                            <a href="{{ route('register') }}" style="color: #10B981; text-decoration: none; font-weight: 600; margin-left: 5px;">
                                Register here
                            </a>
                        </div>
                    </form>
