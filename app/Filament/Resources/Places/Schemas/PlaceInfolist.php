    ...
    public static function configure(Schema $schema): Schema
    {
        return $schema
            ->components([
                ...
                TextEntry::make('social_links')->placeholder('-')->columnSpanFull(),
                TextEntry::make('address'),
                TextEntry::make('country'),
                TextEntry::make('province'),
                TextEntry::make('city'),
                TextEntry::make('district'),
                TextEntry::make('subdistrict')->placeholder('-'),
                TextEntry::make('village')->placeholder('-'),
                TextEntry::make('rt_rw')->placeholder('-'),
                TextEntry::make('neighborhood')->placeholder('-'),
                ...
                TextEntry::make('price_level')->badge(),
